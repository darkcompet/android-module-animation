...
public class DkAnimators {
	// Make private since it contains View class, should move to view package?
	private static ObjectAnimator createAnimator(View view, String property, long startDelay, long duration,
